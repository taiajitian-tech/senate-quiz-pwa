    ...
    <HelpModal open={props.open} onClose={props.onClose} title="最初に（使い方）">
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={styles.box}>
          ...
          <div style={styles.step}><b>1 自動再生</b><span>最初に多くの顔を一気に見ます。秒数は自動再生画面でその場で変更できます。おすすめは <b>顔2秒・名前2秒</b> です。</span></div>
          <div style={styles.step}><b>2 学習（顔→名前）</b><span>開始前に問題数と出題対象を決めて、顔を見て名前を思い出します。</span></div>
          <div style={styles.step}><b>3 逆学習（名前→顔）</b><span>名前から顔も引けるようにして、結び付きを強くします。</span></div>
          <div style={styles.step}><b>4 復習</b><span>開始前に問題数を決めて、忘れそうな議員と苦手な議員を短い時間で定着させます。</span></div>
        </div>
        ...
        <div style={styles.box}>
          ...
          <div style={styles.step}><b>最初の1周</b><span>顔2秒・名前2秒で全体像を作ります。変更は自動再生画面内の＋−で行います。</span></div>
