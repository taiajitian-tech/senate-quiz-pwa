...
const styles: Record<string, React.CSSProperties> = {
  ...
  imgCompact: { width: "min(250px, 68vw)", height: "min(250px, 68vw)", objectFit: "cover", borderRadius: 10, background: "#f3f3f3" },
  ...
  noImgCompact: { width: "min(250px, 68vw)", height: "min(250px, 68vw)", display: "flex", alignItems: "center", justifyContent: "center", color: "#777", background: "#f3f3f3", borderRadius: 10 },
