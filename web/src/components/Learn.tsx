...
import { formatDisplayNameWithKana, getTargetLabels, loadPersonsForTarget, type AppMode, type Person, type Target } from "./data";
          ...
          {loading ? <div style={styles.center}>読み込み中</div> : sessionDone ? (
            ...
            <div style={compactLayout ? styles.quizLayoutCompact : styles.quizLayout}>
              <div style={styles.infoZone}>
                <div style={styles.answerName}>{formatDisplayNameWithKana(current, props.target, props.appMode, items)}</div>
