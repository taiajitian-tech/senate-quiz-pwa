...
const styles: Record<string, React.CSSProperties> = {
  ...
  img: { width: "240px", height: "240px", objectFit: "cover", borderRadius: 12, background: "#f3f3f3" },
  imgCompact: { width: "min(240px, 64vw)", height: "min(240px, 64vw)", objectFit: "cover", borderRadius: 10, background: "#f3f3f3" },
  noImg: { width: "240px", height: "240px", display: "flex", alignItems: "center", justifyContent: "center", color: "#777", background: "#f3f3f3", borderRadius: 12 },
  noImgCompact: { width: "min(240px, 64vw)", height: "min(240px, 64vw)", display: "flex", alignItems: "center", justifyContent: "center", color: "#777", background: "#f3f3f3", borderRadius: 10 },
  ...
  gradeBtnsCompact: { display: "grid", gridTemplateColumns: "1fr", gap: 8, width: "100%", maxWidth: 320, alignSelf: "center" },
  btn: { padding: "12px 12px", borderRadius: 10, border: "1px solid #999", background: "#fff", fontSize: 16 },
  btnCompact: { padding: "10px 10px", borderRadius: 10, border: "1px solid #999", background: "#fff", fontSize: 14, lineHeight: 1.3, width: "100%" },
